...
import { type ConditionEventProp, isAddValueToAttacksBasedOnAbilityWithoutTracker } from "../../types/events.types/ConditionEventProp.type";

import type { Ability } from "../../types/features.types/abilitiesAndSkills.type";
import type { CharacterAttacks } from "../../types/features.types/attacks.types";
import { isConditionProp } from "../../types/features.types/conditions.type";
...
} from "../calculationsAndBuilders/idBuilder";
import { modificationIsApplied, relatedModStillActive } from "../calculationsAndBuilders/modCommonFunctions/generalModFunctions";
import { addResistanceSet } from "../calculationsAndBuilders/modCommonFunctions/modSets";
import { changeBackCanCastCheckingModifications, changeAllCanCastComponent } from "../calculationsAndBuilders/modCommonFunctions/spellcastCalculations";
