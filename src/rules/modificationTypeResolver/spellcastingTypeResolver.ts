...
import type {
  ...
  SpellLevelInterface,
  SpellNameAndLevel,
} from "../../types/features.type.ts/spells.type";
...
type SpellcastingTypeResolver = Pick<
  ...
  "addExchangeToSpellcasting" | "addClassSpellList" | "addSpellToClassSpellList"
>;
...
function onAddingSpellToClassSpellList(
  ...
  return target.map((characterClass) => {
    ...
    const spellList = characterClass.spellcasting.spells.spellList;
    ...
    return {
      ...
      spellcasting: {
        ...
        spells: {
          ...characterClass.spellcasting.spells,
          spellList: addSpellToList(spellList, spellToAdd, modId),
        },
      },
    };
  });
  ...
  return target.map((characterClass) => {
    ...
    return {
      ...
      spellcasting: {
        ...
        spells: {
          ...characterClass.spellcasting.spells,
          spellList: removeSpellFromList(spellList, mod.spell, modId),
        },
      },
    };
  });
